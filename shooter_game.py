...
# '''ШУТЕР 1 день - 2. Управление Класс GameSprite и Player '''
# from pygame import *
...
# '''ШУТЕР 2 день - 1. Класс Enemy. Работа с группой спарайтов '''
# from pygame import *
...
# background = transform.scale(image.load("14960500_5536338.jpg"), (win_width, win_height))
# #создаём спрайты
# ship = Player('11067988_19598325.png', 330, 400, 150, 100, 10)
...
# '''ШУТЕР 3 день . Класс Enemy. Создание группы пули '''
# from pygame import *
# from random import randint
...
'''ШУТЕР-ДОРАБОТКА: АСТЕРОИДЫ И ПЕРЕЗАРЯДКА ПУЛЬ'''
# from pygame import *
# from random import randint
